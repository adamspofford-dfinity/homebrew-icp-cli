...
Homebrew tap for [icp-cli](https://github.com/dfinity/icp-cli), a command-line utility for developing and deploying applications on the Internet Computer Protocol (ICP).
